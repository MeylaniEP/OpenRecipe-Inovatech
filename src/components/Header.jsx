...
function Header() {
  ...
  const activeLinkStyle = {
    color: "rgba(42, 122, 178, 1)",
    fontWeight: "bold",
    borderBottom: "2.5px solid rgba(42, 122, 178, 1)",
  };
  ...
  return (
    <>
      ...
      >
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto d-flex flex-row align-items-center gap-3" style={{ color: "rgba(42, 122, 178, 1)" }}>
            <Nav.Link as={Link} to="/home" style={linkStyle} activeStyle={activeLinkStyle}>Home</Nav.Link>
            <Nav.Link as={Link} to="/inggredients" style={linkStyle} activeStyle={activeLinkStyle}>Ingredients</Nav.Link>
            <Nav.Link as={Link} to="/tools" style={linkStyle} activeStyle={activeLinkStyle}>Tools</Nav.Link>
            <Nav.Link as={Link} to="/shop" style={linkStyle} activeStyle={activeLinkStyle}>Shop</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
      ...
      <style>{`
        ...
        .sidebar .nav-link.active {
          color: rgba(42, 122, 178, 1);
          font-weight: bold;
          border-bottom: 2.5px solid rgba(42, 122, 178, 1);
        }
      `}</style>
    </>
  );
