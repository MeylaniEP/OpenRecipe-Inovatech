      ...
      <div className="d-flex flex-wrap gap-3 justify-content-start align-items-center w-100 my-3">
        {meatInggredients.map((meatInggredient, index) => (
          ...
          boxShadow: "0 0.25rem 0.5rem rgba(0, 0, 0, 0.25)",}}>
            <img src={meatInggredient.image} alt={meatInggredient.name} className="img-fluid" />
            <label className="text-center" htmlFor={meatInggredient.name}>
              {meatInggredient.name}
            </label>
          </div>
        ))}
      </div>
...
export default AnimalInggredient
